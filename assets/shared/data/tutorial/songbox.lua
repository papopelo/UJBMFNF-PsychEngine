...
function onCreatePost()
      --image 1
makeLuaSprite('Image1', 'good-luck-gf/luck2', -600, 12)
...
--image 2
makeLuaSprite('Image2', 'good-luck-gf/luck2', -600, 12)
...
--image 3
makeLuaSprite('Image3', 'good-luck-gf/luck2', -600, 12)
...
--image 4
makeLuaSprite('Image4', 'good-luck-gf/luck2', -600, 12)
...
--image 5
makeLuaSprite('Image5', 'good-luck-gf/luck2', -600, 12)
...
--image 6
makeLuaSprite('Image6', 'good-luck-gf/luck2', -600, 12)
...
--image 7
makeLuaSprite('Image7', 'good-luck-gf/luck2', -600, 12)
...
--image 8
makeLuaSprite('Image8', 'good-luck-gf/luck2', -600, 12)
...
function onCreate()
   ...
   makeLuaText('JukeBoxSubText', 'Good Luck!', 0-IntroTagWidth, 60)
    ...
    makeLuaText('JukeAuthorText', 'Kawai Sprite', 0-IntroTagWidth, 60)
    ...
    makeLuaText('JukeScoreText', 'Best Score: idk :p', 0-IntroTagWidth, 60)
